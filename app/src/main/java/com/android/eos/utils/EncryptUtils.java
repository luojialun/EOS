...
public final class EncryptUtils {
    ...
    public static String encryptYmDes(final byte[] data,
                                      final byte[] key) {
        String transform = "DES/CBC/PKCS5Padding";
        byte[] iv1 = {(byte) 0x12, (byte) 0x34, (byte) 0x56,
                (byte) 0x78, (byte) 0x90, (byte) 0xAB, (byte) 0xCD, (byte) 0xEF};
        try {
            return new String(encryptDES2Base64(data, key, transform, iv1), "UTF-8");
    ...
    public static String decryptYmDes(final byte[] data,
                                      final byte[] key) {
        String transform = "DES/CBC/PKCS5Padding";
        byte[] iv1 = {(byte) 0x12, (byte) 0x34, (byte) 0x56,
                (byte) 0x78, (byte) 0x90, (byte) 0xAB, (byte) 0xCD, (byte) 0xEF};
        try {
            return new String(decryptBase64DES(data, key, transform, iv1), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return "";
        }
