...
public final class AppUtils {
    ...
    public static void installApp(final File file, final String authority) {
       ...
       BaseApp.getContext().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        BaseApp.getContext().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
       BaseApp.getContext().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
