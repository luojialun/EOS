 ...
 */
package com.android.eos.net.callbck;
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public void onError(com.lzy.okgo.model.Response<T> response) {
        ...
        if (response.getException() instanceof SocketTimeoutException) {
            ToastUtils.showToast(BaseApp.getContext().getResources().getString(R.string.socket_time_out));
        } else if (response.getException() instanceof SocketException) {
            ToastUtils.showToast(BaseApp.getContext().getResources().getString(R.string.socket_exception));
        } else if (response.getException() instanceof JsonSyntaxException) {
            ToastUtils.showToast(BaseApp.getContext().getResources().getString(R.string.error_parse));
        }
    }
}
